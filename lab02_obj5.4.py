...
while(1):
    ...
    cloudwatch = boto3.client('cloudwatch',region_name='us-west-1',aws_access_key_id="aws_access_key_id",aws_secret_access_key="aws_secret_access_key")
